...
from services.agent.orchestrator.orchestrator.agent_service import ground_response, tool_call
        ...
        if planning_response.answer == "None":
            ...
            while steps < MAX_STEPS and confidence <CONFIDENCE_THRESHOLD:
                ...
                if grounding_response.confidence >= CONFIDENCE_THRESHOLD:
                    ...
                    if grounding_response.tool_name != "None":
                        response_message = tool_call(grounding_response.tool_name, grounding_response.tool_parameters)
                        # Update the state
                        request_analysis_reviewed.state.grounding_state.models.append(response_message)
